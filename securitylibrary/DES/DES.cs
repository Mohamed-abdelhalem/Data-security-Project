...
namespace SecurityLibrary.DES
{
    ...
    public class DES : CryptographicTechnique
    {
        ...
        int[,] PermC_1 = new int[8, 7] { { 57, 49, 41, 33, 25, 17, 9 },
                                        { 1, 58, 50, 42, 34, 26, 18 },
                                        { 10, 2, 59, 51, 43, 35, 27 },
                                        { 19, 11, 3, 60, 52, 44, 36 },
        ...
        , PermC_2 = new int[8, 6] { { 14, 17, 11, 24, 1, 5 },
                                    { 3, 28, 15, 6, 21, 10 },
                                    { 23, 19, 12, 4, 26, 8 },
                                    { 16, 7, 27, 20, 13, 2 },
                                    { 41, 52, 31, 37, 47, 55},
       ...
       , s7 = new int[4, 16] { { 4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 },
        ...
        ,       IP = new int[8, 8] { { 58, 50, 42, 34, 26, 18, 10, 2 },
        ...
        ,       IP_1 = new int[8, 8] { { 40, 8, 48, 16, 56, 24, 64, 32 },
        ...
        string x = "", h = "", ebit = "", exork = "", tsb = "", pp = "", lf = "", t = "" ,Lm = "", Rm = "";
        ...
        public override string Decrypt(string cipherText, string key)
        {
            ...
            for (int i = 0; i < bcipher.Length / 2; i++)
            {
                Lm = Lm + bcipher[i];
                Rm = Rm + bcipher[i + bcipher.Length / 2];
            }
        ...
        public override string Encrypt(string plainText, string key)
        {
            ...
            string bkey = Convert.ToString(Convert.ToInt64(key, 16), 2).PadLeft(64, '0');
            for (int i = 0; i < bplain.Length / 2; i++)
            {
                Lm = Lm + bplain[i];
                Rm = Rm + bplain[i + bplain.Length / 2];
            }
            //premutate key by pc-1
            string tmpk = "";
            List<string> C = new List<string>() , D = new List<string>();
            ...
            for (int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
                {
                    ip = ip + bplain[IP[i, j] - 1];
                }
            }
            List<string> L = new List<string>() ,  R = new List<string>();
            string l = ip.Substring(0, 32) , r = ip.Substring(32, 32);
            L.Add(l);
            R.Add(r);
            for (int i = 0; i < 16; i++)
            {
